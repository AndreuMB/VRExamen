...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void DestroyCube_OnCollisionEnter_mFA54D55AB886F1FD7E06F9CAAFF90CFAA7DBF1DA (DestroyCube_t4DA9AC1A0892D4781B8A249B4726855CDAAC428D* __this, Collision_tBCC6AEBD9A63E6DA2E50660DAC03CDCB1FF7A9B0* ___collision0, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		V_1 = L_8;
		// Vector3 localPoint = collision.gameObject.transform.InverseTransformPoint(collisionPoint);
		...
		V_5 = L_15;
		String_t* L_16;
		L_16 = Vector3_ToString_m6C24B9F0382D25D75B05C606E127CD14660574EE((&V_5), NULL);
		String_t* L_17;
		L_17 = String_Concat_m9E3155FB84015C823606188F53B47CB44C444991(_stringLiteral4D808631E197333E744F744ADD607FA3B5EFC73F, L_16, NULL);
...
IL_0130:
	{
		...
		bool L_36;
		L_36 = String_op_Equality_m030E1B219352228970A076136E455C4E568C02C1(L_35, _stringLiteralD301F5AE5A5B061D78BCEA581DB89CEF31A603D2, NULL);
		if (!L_36)
		{
			goto IL_0170;
		}
	}
	{
		...
		bool L_39;
		L_39 = String_op_Equality_m030E1B219352228970A076136E455C4E568C02C1(L_38, _stringLiteral2EC3D1F2F3F179401F0320BA57A33544137F457F, NULL);
		if (!L_39)
		{
			goto IL_0170;
		}
	}
	{
		...
		ScoreCount_tEFF795D7649CD9B2B869BF5DF955778B514AD376* L_41 = V_0;
		NullCheck(L_41);
		ScoreCount_addScore_m4FB06D87920EF268933C946D1702DE41E09B8B58(L_41, NULL);
		return;
	}
...
IL_0170:
	{
		...
		Collision_tBCC6AEBD9A63E6DA2E50660DAC03CDCB1FF7A9B0* L_42 = ___collision0;
		NullCheck(L_42);
		...
		bool L_45;
		L_45 = String_op_Equality_m030E1B219352228970A076136E455C4E568C02C1(L_44, _stringLiteralEE5A8D76CDF6C02702C269031CBEF2BA1BE22AE6, NULL);
		if (!L_45)
		{
			goto IL_01af;
		}
	}
	{
		...
		bool L_48;
		L_48 = String_op_Equality_m030E1B219352228970A076136E455C4E568C02C1(L_47, _stringLiteralE10AFCD044674871E7FF7CB7DF5D2E425E019321, NULL);
		if (!L_48)
		{
			goto IL_01af;
		}
	...
	{
		// scoreScript.addScore();
		ScoreCount_tEFF795D7649CD9B2B869BF5DF955778B514AD376* L_49 = V_0;
		NullCheck(L_49);
		ScoreCount_addScore_m4FB06D87920EF268933C946D1702DE41E09B8B58(L_49, NULL);
		// Destroy(gameObject);
